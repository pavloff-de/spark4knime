...
/**
 * <code>NodeView</code> for the "TableToRDD" Node.
...
public class TableToRDDNodeView extends NodeView<TableToRDDNodeModel> {
     ...
     * Creates a new view.
     * 
     * @param nodeModel The model (class: {@link TableToRDDNodeModel})
     */
    ...
    protected void modelChanged() {
        ...
        // update the view.
        TableToRDDNodeModel nodeModel = 
            (TableToRDDNodeModel)getNodeModel();
