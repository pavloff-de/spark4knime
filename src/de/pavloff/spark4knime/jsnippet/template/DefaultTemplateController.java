 ...
 */
package de.pavloff.spark4knime.jsnippet.template;

import java.awt.Component;
import java.util.Map;

import de.pavloff.spark4knime.jsnippet.JSnippetTemplate;
import de.pavloff.spark4knime.jsnippet.JavaSnippetForRDDNodeDialog;
...
public class DefaultTemplateController implements TemplateController {
    private JavaSnippetForRDDNodeDialog m_model;
    private JavaSnippetForRDDNodeDialog m_preview;
     ...
     */
    public DefaultTemplateController(final JavaSnippetForRDDNodeDialog model,
            final JavaSnippetForRDDNodeDialog preview) {
        super();
        m_model = model;
        m_preview = preview;
    }
