...
import de.pavloff.spark4knime.jsnippet.template.AddTemplateDialog;
import de.pavloff.spark4knime.jsnippet.template.DefaultTemplateController;
import de.pavloff.spark4knime.jsnippet.template.TemplateProvider;
import de.pavloff.spark4knime.jsnippet.template.TemplatesPanel;
import de.pavloff.spark4knime.jsnippet.ui.ColumnList;
import de.pavloff.spark4knime.jsnippet.ui.FieldsTableModel;
import de.pavloff.spark4knime.jsnippet.ui.FieldsTableModel.Column;
import de.pavloff.spark4knime.jsnippet.ui.FlowVariableList;
import de.pavloff.spark4knime.jsnippet.ui.InFieldsTable;
import de.pavloff.spark4knime.jsnippet.ui.JSnippetFieldsController;
import de.pavloff.spark4knime.jsnippet.ui.JSnippetTextArea;
import de.pavloff.spark4knime.jsnippet.ui.JarListPanel;
import de.pavloff.spark4knime.jsnippet.ui.OutFieldsTable;
import de.pavloff.spark4knime.jsnippet.ui.OutFieldsTableModel;
 ...
 * @author Heiko Hofer
 */
public class JavaSnippetForRDDNodeDialog extends NodeDialogPane {
    private static final NodeLogger LOGGER = NodeLogger.getLogger(
            JavaSnippetForRDDNodeDialog.class);
     ...
     */
    @SuppressWarnings("rawtypes")
    public JavaSnippetForRDDNodeDialog(final Class templateMetaCategory) {
     ...
     */
    @SuppressWarnings("rawtypes")
    protected JavaSnippetForRDDNodeDialog(final Class templateMetaCategory,
        ...
        addTemplateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                if (null != newTemplate) {
                    ...
                    JavaSnippetForRDDNodeDialog.this.getPanel().validate();
                }
            }
        });
    ...
    private JPanel createTemplatesPanel() {
        JavaSnippetForRDDNodeDialog preview = createPreview();
     ...
     */
    protected JavaSnippetForRDDNodeDialog createPreview() {
        return new JavaSnippetForRDDNodeDialog(m_templateMetaCategory, true);
    }
