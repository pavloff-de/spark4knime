...
/**
 * <code>NodeView</code> for the "CountByKey" Node.
...
public class CountByKeyNodeView extends NodeView<CountByKeyNodeModel> {
     ...
     * Creates a new view.
     * 
     * @param nodeModel The model (class: {@link CountByKeyNodeModel})
     */
    ...
    protected void modelChanged() {
        ...
        // update the view.
        CountByKeyNodeModel nodeModel = 
            (CountByKeyNodeModel)getNodeModel();
